            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p>M. Nur Aqil Bahri,<br> 21102144</p>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('student.index')}}"><i class="fa fa-circle-o"></i>Data Student</a>
                            </li>
                            <li ><a href="{{route('student.create')}}"><i class="fa fa-circle-o"></i>Tambah Student</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
